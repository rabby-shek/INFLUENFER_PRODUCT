...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="backpak.css">
  ...
  <div class="Navbar">
     ...
     <nav class="Navbar__Items Navbar__Items--right">
       ...
       <div class="Navbar__Link">
        ...
        <div class="user"><small ><?php echo $user_data['user_name']; ?></small></div>
      </div>
      <div class="Navbar__Link">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="./images/Backpack (1).jpg"  style="height:600px;" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="./images/Backpack (2).jpg" style="height:600px;" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="./images/Backpack (3).jpg" style="height:600px;" alt="Third slide">
    </div>
  </div>
                ...
                <div class="description description-tabs">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane fade active in" id="more-information">
                            ...
                            <p>
                            Carry everything you need for a busy day in this generously-sized backpack. two main zip compartments and two smaller pockets help keep you organized. LoadSpring shoulder straps make carrying heavy books and gear more comfortable....
                            </p>
                        </div>
