...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="vrsets.css">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="./images/VR Sets (1).jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="./images/VR Sets (2).jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="./images/VR Sets (3).jpg" alt="Third slide">
    </div>
  </div>
                ...
                <div class="description description-tabs">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane fade active in" id="more-information">
                            ...
                            <p>
                            Experience our most advanced all-in-one VR system yet with Oculus Quest 2. No PC or console...
                            </p>
                        </div>
