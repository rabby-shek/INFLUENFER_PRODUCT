   ...
   <div class="container">
    ...
    <div class="product-content product-wrap clearfix product-deatil">
        <div class="row">
            ...
            <div id="carouselExampleControls" class="carousel slide" style="height:280px;" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="./images/SmartWatch (1).jpg" style="height:280px;" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="./images/SmartWatch (2).jpg" style="height:280px;" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="./images/SmartWatch (3).jpg" alt="Third slide">
    </div>
  </div>
                ...
                <div class="description description-tabs">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane fade active in" id="more-information">
                            ...
                            <p>
                            Apple Watch Series 6 44mm Silver Aluminum, White Sport Band comes with LTPO OLED Always...
                            </p>
                        </div>
