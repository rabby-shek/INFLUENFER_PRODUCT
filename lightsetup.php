...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="lightsetup.css">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="./images/lights.png" style="height:350px;" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="./images/light setup 03.jpg" style="height:350px;" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="./images/light setup 03.jpg" style="height:350px;" alt="Third slide">
    </div>
  </div>
                ...
                <div class="description description-tabs">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane fade active in" id="more-information">
                            ...
                            <p>
                            Best for YouTube Home Studio setup, Best Suitable for Continuous Light Source...
                            </p>
                        </div>
