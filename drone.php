...
<html lang="en">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="./images/drone.png" style="height:350px;" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="./images/Drone 02.jpg" style="height:350px;" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="./images/Drone 03.jpg" style="height:350px;" alt="Third slide">
    </div>
  </div>
                ...
                <div class="description description-tabs">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane fade active in" id="more-information">
                            ...
                            <p>
                           Vision Sensor + GPS Precise Hover, 30-min Max. Flight Time, 3-Axis Gimbal 2.7K Camera, 4 km...
                            </p>
                        </div>
