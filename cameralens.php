...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="cameralens.css">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="./images/Camera Lens (1).jpg" style="height:350px;" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="./images/Camera Lens (2).jpg" style="height:350px;" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="./images/Camera Lens (3).jpg" style="height:350px;" alt="Third slide">
    </div>
  </div>
                ...
                <div class="description description-tabs">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane fade active in" id="more-information">
                            ...
                            <p>
                            The Canon EF-S 18-135mm IS USM Zoom Lens is a zoom optimized lens for sti... 
                            </p>
                        </div>
