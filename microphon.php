...
<html lang="en">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="./images/mic.png" style="height:350px;" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="./images/microphone 02.jpg" style="height:350px;" alt="Second slide">
    </div>
    <div class="carousel-item"> 
      <img class="d-block w-100" src="./images/microphone 03.jpg" style="height:350px;" alt="Third slide">
    </div>
  </div>
                ...
                <div class="description description-tabs">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane fade active in" id="more-information">
                            ...
                            <p>
                            smooth, natural sound and low noise, Custom shock mount, Switchable 80 Hz high-pass filter...
                            </p>
                        </div>
